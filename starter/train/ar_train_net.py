...
from torchrl.algo.off_policy.ar_sac_net import ARSAC_Net
from torchrl.collector.para.async_mt import AsyncMultiTaskParallelCollectorForActionRepresentation_Net
...
def experiment(args):
    ...
    experiment_name_v2 = experiment_name + "_net"
    ...
    params['general_setting']['collector'] = AsyncMultiTaskParallelCollectorForActionRepresentation_Net(
