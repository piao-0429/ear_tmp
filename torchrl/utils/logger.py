...
class Logger():
    ...
    def add_epoch_info(self, epoch_num, total_frames, total_time, total_training_steps, infos, csv_write=True):
        if csv_write:
            if epoch_num == 0:
                csv_titles = ["EPOCH", "Time Consumed", "Total Frames", "Training Steps"]
            csv_values = [epoch_num, total_time, total_frames, total_training_steps]
        ...
        self.logger.info("Training Steps:{}s".format(total_training_steps))
