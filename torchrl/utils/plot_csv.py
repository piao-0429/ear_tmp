    ...
    for seed in args.seed:
        ...
        with open(file_path,'r') as f:
            ...
            for row in csv_reader:
                ...
                temp_step_number.append(int(row["Training Steps"]))
                # temp_step_number.append(int(row["Epoch"]))
                # temp_step_number.append(int(row["Number of env steps total"]))
...
# ax1.set_xlabel('Million Samples', fontsize=25)
ax1.set_xlabel('Million Steps', fontsize=50)
# ax1.set_xlabel('Steps', fontsize=50)
...
plt.title("{}".format(env_name), fontsize=60)
