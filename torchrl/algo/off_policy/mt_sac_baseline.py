...
class MTSAC_BASELINE(OffRLAlgo):
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(MTSAC_BASELINE,self).__init__(**kwargs)
        self.pf = pf
        self.qf1=qf1
        self.qf2=qf2
    ...
    def update(self, batch):
            ...
            sample_info = self.pf.explore(torch.cat((obs,task_inputs),dim=-1), return_log_probs=True )
            ...
            with torch.no_grad():
                ...
                target_sample_info = self.pf.explore(torch.cat((next_obs,task_inputs),dim=-1), return_log_probs=True )
