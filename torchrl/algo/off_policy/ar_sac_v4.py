...
class ARSAC_v4(OffRLAlgo):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ARSAC_v4,self).__init__(**kwargs)
    ...
    def update(self, batch):
            ...
            q1_pred = self.qf1([obs, actions, embeddings4q.detach()])
            q2_pred = self.qf2([obs, actions, embeddings4q.detach()])
            ...
            with torch.no_grad():
                ...
                target_q1_pred = self.target_qf1([next_obs, target_actions, target_embeddings4q])
                target_q2_pred = self.target_qf2([next_obs, target_actions, target_embeddings4q])
            ...
            q_new_actions = torch.min(
                self.qf1([obs, new_actions, embeddings4q]),
                self.qf2([obs, new_actions, embeddings4q]))
            """
            Policy Loss
            """
