...
class ARSAC_v2(OffRLAlgo):
    """
    SAC_v2 for Action Representation
    """
    ...
    def update(self, batch):
            ...
            embeddings4q = embeddings.detach()
            ...
            with torch.no_grad():
                ...
                target_q1_pred = self.target_qf1([next_obs, target_actions,embeddings4q])
                target_q2_pred = self.target_qf2([next_obs, target_actions,embeddings4q])
