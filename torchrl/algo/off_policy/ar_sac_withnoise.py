...
class ARSAC_withNoise(OffRLAlgo):
    """
    SAC for Action Representation with noise
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ARSAC_withNoise,self).__init__(**kwargs)
    ...
    def update(self, batch):
            ...
            # print('Before')
            # print(list(self.pf_task.parameters()))

        
            self.pf_optimizer.zero_grad()
            policy_loss.backward()
            # for param in self.pf_task.parameters():
            #     print(param.grad)
